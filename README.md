...
The forth coming publication will contain a number of examples, alternatively, check out the <a href="https://github.com/acnash/RDrugTrajectory/blob/master/rdrugtrajectory_0.2.0.pdf">reference manual</a>.
